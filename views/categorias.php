...
<span class="material-symbols-outlined text-primary" data-icon="home_repair_service">home_repair_service</span>
<h3 class="font-headline text-lg font-bold text-on-surface">Categorias de Serviços</h3>
</div>
...
<span class="material-symbols-outlined text-outline/50 mr-2 group-focus-within:text-primary" data-icon="label">label</span>
...
<td class="px-6 py-4">
<span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-tertiary-fixed text-on-tertiary-fixed">12 serviços</span>
</td>
...
<td class="px-6 py-4">
<span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-tertiary-fixed text-on-tertiary-fixed">24 serviços</span>
</td>
<td class="px-6 py-4 text-right">
<div class="flex justify-end gap-2">
<button class="p-2 hover:bg-white rounded-lg text-on-surface-variant transition-colors hover:text-primary">
...
<td class="px-6 py-4">
<span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-tertiary-fixed text-on-tertiary-fixed">18 serviços</span>
</td>
<td class="px-6 py-4 text-right">
<div class="flex justify-end gap-2">
<button class="p-2 hover:bg-white rounded-lg text-on-surface-variant transition-colors hover:text-primary">
...
<td class="px-6 py-4">
<span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-tertiary-fixed text-on-tertiary-fixed">8 serviços</span>
</td>
<td class="px-6 py-4 text-right">
<div class="flex justify-end gap-2">
<button class="p-2 hover:bg-white rounded-lg text-on-surface-variant transition-colors hover:text-primary">
...
<td class="px-6 py-4">
<span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-tertiary-fixed text-on-tertiary-fixed">84 itens</span>
</td>
<td class="px-6 py-4 text-right">
<div class="flex justify-end gap-2">
<button class="p-2 hover:bg-white rounded-lg text-on-surface-variant transition-colors hover:text-primary">
...
<td class="px-6 py-4">
<span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-tertiary-fixed text-on-tertiary-fixed">156 itens</span>
</td>
<td class="px-6 py-4 text-right">
<div class="flex justify-end gap-2">
<button class="p-2 hover:bg-white rounded-lg text-on-surface-variant transition-colors hover:text-primary">
...
<td class="px-6 py-4">
<span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-tertiary-fixed text-on-tertiary-fixed">42 itens</span>
</td>
<td class="px-6 py-4 text-right">
<div class="flex justify-end gap-2">
<button class="p-2 hover:bg-white rounded-lg text-on-surface-variant transition-colors hover:text-primary">
...
<td class="px-6 py-4">
<span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-tertiary-fixed text-on-tertiary-fixed">98 itens</span>
</td>
<td class="px-6 py-4 text-right">
<div class="flex justify-end gap-2">
<button class="p-2 hover:bg-white rounded-lg text-on-surface-variant transition-colors hover:text-primary">
...
<!-- Dashboard Summary Area (Visual Polish) -->
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 pt-8">
<div class="bg-surface-container-lowest p-6 rounded-xl border border-outline-variant/10 flex items-center gap-4">
<div class="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center">
<span class="material-symbols-outlined text-primary" data-icon="auto_awesome_motion">auto_awesome_motion</span>
</div>
<div>
<p class="text-xs text-on-surface-variant font-bold uppercase tracking-wider">Total de Categorias</p>
<p class="text-2xl font-black font-headline text-on-background">28</p>
</div>
</div>
<div class="bg-surface-container-lowest p-6 rounded-xl border border-outline-variant/10 flex items-center gap-4">
...
<div>
<p class="text-xs text-on-surface-variant font-bold uppercase tracking-wider">Peças Catalogadas</p>
<p class="text-2xl font-black font-headline text-on-background">1,452</p>
</div>
</div>
<div class="bg-surface-container-lowest p-6 rounded-xl border border-outline-variant/10 flex items-center gap-4">
...
<div>
<p class="text-xs text-on-surface-variant font-bold uppercase tracking-wider">Serviços Ativos</p>
<p class="text-2xl font-black font-headline text-on-background">312</p>
</div>
</div>
</div>
</div>
